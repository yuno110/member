...
- [ ] M-05 회원가입과 중복 확인 · 상태 todo 
- [ ] M-06 로그인 · 상태 todo 
- [ ] M-07 토큰 재발급과 로그아웃 · 상태 todo 
- [ ] M-08 내 정보 조회·수정 · 상태 todo 
- [ ] M-09 비밀번호 변경과 탈퇴 · 상태 todo 
- [ ] M-10 회원 프로필 조회와 내부 API · 상태 todo 
- [ ] M-11 마무리 · 상태 todo 
...
- [ ] `application-local.yml` 생성하고 MySQL 비밀번호 기입 (`sp-docs/tech-stack.md` §4.3.1)
